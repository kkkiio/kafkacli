...
- [ ] 1.3 允许 `KafkaPartitionConsumer` 更新内部状态（`offset`、`is_closed` 标记为 `mut`）
- [ ] 1.4 在 `close` 中设置关闭状态并在二次 `fetch_messages` 时阻止访问
- [x] 1.5 移除异步通道和复杂状态管理
